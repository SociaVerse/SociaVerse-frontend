...
import { Globe, Menu, Search, Bell, User, Sparkles, Users } from "lucide-react"
...
const navLinks = [
  ...
  { href: "/friends", label: "Friends", icon: <User className="w-4 h-4" /> },
      ...
      <div className="px-6 flex h-16 items-center justify-between">
        ...
        >
          <Link href="/" className="flex items-center space-x-2 group">
            <motion.div
              className="relative flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-md group-hover:shadow-blue-500/20 transition-all duration-300"
            ...
            <motion.span
              className="font-bold text-lg bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-indigo-400"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        >
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px] p-6 bg-slate-900/95 backdrop-blur-lg border-l border-slate-700/50">
              ...
              >
                <Link href="/" className="flex items-center space-x-2 mb-8 group" onClick={() => setIsOpen(false)}>
                  <motion.div
