...
import { FaLock, FaFacebook, FaTwitter, FaApple, FaUserFriends, FaImage, FaGlobeAmericas } from "react-icons/fa"
import { z } from "zod"
      ...
      >
        ...
        <div className="flex flex-col justify-center p-5 sm:p-8 md:p-12 animate-slideInLeft animation-delay-150">
          <div className="mb-6 sm:mb-8 animate-slideInUp animation-delay-300">
            <h1 className="mb-2 sm:mb-3 text-2xl sm:text-3xl font-bold text-white">Welcome to SociaVerse</h1>
          ...
          {!showEmailLogin ? (
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              <div className="my-4 sm:my-6 flex items-center animate-fadeIn animation-delay-900">
                ...
                <span className="mx-3 sm:mx-4 text-xs sm:text-sm text-slate-500">OR</span>
                <div className="flex-grow border-t border-slate-700"></div>
              </div>
            ...
            <form onSubmit={handleEmailLogin} className="flex flex-col gap-4 sm:gap-5 animate-fadeIn">
              <div className="animate-slideInUp animation-delay-150">
                <label htmlFor="email" className="mb-1.5 sm:mb-2 block text-xs sm:text-sm font-medium text-slate-300">
                  Email address
                </label>
                <div className="relative group">
                  <MdEmail className="absolute left-3 top-1/2 h-4 w-4 sm:h-5 sm:w-5 -translate-y-1/2 text-slate-500 transition-colors duration-200 group-hover:text-blue-400" />
                  <Input
                    id="email"
                    type="email"
                    ...
                    className={`pl-10 bg-slate-900/50 border-slate-700 text-white text-sm sm:text-base py-5 sm:py-6 placeholder:text-slate-500 transition-all duration-200 focus:ring-2 focus:ring-blue-500/50 hover:border-slate-500 ${errors.email ? 'border-red-500 focus:ring-red-500/50' : 'focus:border-blue-500'}`}
                  />
                </div>
              ...
              <div className="animate-slideInUp animation-delay-300">
                <label htmlFor="password" className="mb-1.5 sm:mb-2 block text-xs sm:text-sm font-medium text-slate-300">
                  Password
                </label>
                <div className="relative group">
                  <FaLock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500 transition-colors duration-200 group-hover:text-blue-400" />
                  <Input
                    id="password"
                    type="password"
                    placeholder="••••••••"
                    ...
                    className={`pl-10 bg-slate-900/50 border-slate-700 text-white text-sm sm:text-base py-5 sm:py-6 placeholder:text-slate-500 transition-all duration-200 focus:ring-2 focus:ring-blue-500/50 hover:border-slate-500 ${errors.password ? 'border-red-500 focus:ring-red-500/50' : 'focus:border-blue-500'}`}
                  />
                </div>
              ...
              <div className="flex items-center justify-between animate-slideInUp animation-delay-450">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 text-xs sm:text-sm text-slate-400">
                    Remember me
                  </label>
                </div>
                <a href="#" className="text-xs sm:text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors duration-200">
                  Forgot password?
                </a>
              </div>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 md:p-12 text-center">
            <div className="relative mb-6 md:mb-8 h-20 w-20 md:h-24 md:w-24 animate-float">
              ...
              <Image 
                ...
                width={96} 
                height={96} 
                className="relative z-10 rounded-full drop-shadow-xl object-cover animate-pulse-slow filter brightness-110 contrast-105"
              />
            </div>
            ...
            <p className="mb-6 md:mb-8 text-base md:text-lg text-slate-300 animate-slideInUp animation-delay-450">
              Connect with friends, share moments, and discover new experiences in our social universe.
            </p>
            <div className="flex flex-col gap-3 md:gap-4 animate-fadeIn animation-delay-600">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <p className="text-left text-sm md:text-base text-slate-300">Connect with friends and family</p>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <div className="flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-slate-700/70">
                  <FaImage className="h-4 w-4 md:h-5 md:w-5 text-blue-400" />
                </div>
                <p className="text-left text-sm md:text-base text-slate-300">Share your favorite moments</p>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <div className="flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-slate-700/70">
                  <FaGlobeAmericas className="h-4 w-4 md:h-5 md:w-5 text-blue-400" />
                </div>
                <p className="text-left text-sm md:text-base text-slate-300">Discover content from around the world</p>
              </div>
            </div>
          </div>
        </div>
