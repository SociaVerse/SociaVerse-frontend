...
export default function CreateEventPage() {
    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-slate-100 flex flex-col items-center py-20 px-4 relative overflow-hidden selection:bg-purple-500/30">
            {/* Ambient Background */}
                        ...
                        {currentStep < STEPS.length ? (
                            ...
                            >
                                <span className="flex items-center">
                                    Publish Event <Trophy className="w-5 h-5 ml-2 group-hover:rotate-12 transition-transform" />
                                </span>
                            </Button>
                        )}
                    </div>
    ...
    return (
        <div className="space-y-10">
            <div className="text-center md:text-left">
                <h2 className="text-2xl font-bold text-white mb-2">Basic Essentials</h2>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3">
                    ...
                    <div className="group relative h-60 rounded-3xl border-2 border-dashed border-slate-700 bg-slate-900/30 overflow-hidden flex flex-col items-center justify-center cursor-pointer transition-all hover:border-purple-500/50 hover:bg-slate-800/50">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-4 transition-transform group-hover:scale-105">
                            <div className="w-16 h-16 rounded-full bg-slate-800 flex items-center justify-center shadow-lg group-hover:bg-purple-500 group-hover:text-white transition-colors">
                                <ImageIcon className="w-8 h-8 text-slate-400 group-hover:text-white" />
                            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                        ...
                        <Input
                            ...
                            className="bg-neutral-950/50 border-slate-800 focus:border-purple-500 h-14 rounded-xl text-lg px-4"
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative">
                            <select
                                className="w-full h-14 rounded-xl border border-slate-800 bg-neutral-950/50 px-4 text-slate-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 appearance-none transition-all cursor-pointer hover:bg-neutral-900"
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                        ...
                        <Input
                            type="datetime-local"
                            className="bg-neutral-950/50 border-slate-800 focus:border-purple-500 h-14 rounded-xl px-4 text-slate-300"
