...
export default function CommunityLayout({
    ...
    return (
        <div className="flex h-screen bg-slate-950 text-white overflow-hidden pt-16">

            {/* Sidebar */}
            <aside
                className="w-64 bg-slate-900 border-r border-white/5 flex flex-col transition-colors duration-500"
                style={{
                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="space-y-1">
                            <NavItem href={`/community/${slug}`} icon={Info} label="Overview" active={pathname === `/community/${slug}`} primaryColor={primaryColor} />
                            <NavItem href={`/community/${slug}/events`} icon={Calendar} label="Events & Announcements" active={pathname.includes('/events')} primaryColor={primaryColor} />
                            <NavItem href={`/community/${slug}/support`} icon={HelpCircle} label="Help & Support" active={pathname.includes('/support')} primaryColor={primaryColor} />
                        </div>
                    </div>
...
function NavItem({ href, icon: Icon, label, active, primaryColor }: { href: string, icon: any, label: string, active: boolean, primaryColor: string }) {
    return (
        <Link
            href={href}
